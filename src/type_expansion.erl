...
map_find_form(Type, Arity, RecMap) ->
    case map_find_form(type, Type, Arity, RecMap) of
        error ->
            map_find_form(opaque, Type, Arity, RecMap);
        {ok, Form} ->
            {ok, Form}
    end.

map_find_form(TypeMode, Type, Arity, RecMap) ->
    case maps:find({TypeMode, Type, Arity}, RecMap) of
